...
let slider_about = new Swiper('.theater__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.theater__button-next',
		prevEl: '.theater__button-prev',
	},
	/*
	breakpoints: {
		320: {
...
let slider_staging = new Swiper('.staging__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.staging__button-next',
		prevEl: '.staging__button-prev',
	},
	/*
	breakpoints: {
		320: {
...
if (iconMenu != null) {
	...
	let menuSocial = document.querySelector(".header-menu__social");
